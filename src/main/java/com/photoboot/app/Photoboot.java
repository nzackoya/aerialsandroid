...
import com.photoboot.adapter.SideAdapter;
import com.photoboot.fragments.PhotoListFragment;
import java.util.ArrayList;
import java.util.List;

public class Photoboot extends ActionBarActivity implements FragmentManager.OnBackStackChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photoboot);
        ...
        sideAdapter.add(PhotoListFragment.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.photoboot, menu);
